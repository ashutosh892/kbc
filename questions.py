QUESTIONS = [
        ...
        {
            "name": " on which date India has declared Kargil War ?",
            "option1": "3rd may 1999",
            "option2": "2nd may 1999",           
            "option3": "2nd april 1999",
            "option4": "3rd april 1999",
            "answer": 1

        },
        {
            "name": " Who was the first Man to Climb Mount Everest Without Oxygen?",
            "option1": "Phu Dorj",
            "option2": "Junko Tabei",           
            "option3": "Reinhold Messner",
            "option4": "Peter Habeler",
            "answer": 1
        }
