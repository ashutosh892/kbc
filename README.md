...
### List of Tasks ( Complete kbc function ):
  ...
  * As he correctly answers question number 10, the minimum reward becomes Rs. 3,20,000 (Second Level)
  ...
  There are 50-50 and swap_question life-lines .
  
  50-50         --> two incorrect options will get disappeared

  swap_question --> the question is swapped with another question based on the difficulty of question on which the lifeline is asked for

  * 50-50 and swap_question lifelines can be used ONLY ONCE.
  * User can also use both the lifelines on one question.
